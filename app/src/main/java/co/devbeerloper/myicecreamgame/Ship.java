...
public class Ship {
    ...
    public static final int SPRITE_SIZE_HEIGTH=120;
    ...
    public Ship (Context context, float screenWidth, float screenHeigth){
        ...
        Bitmap originalBitmap= BitmapFactory.decodeResource(context.getResources(), R.drawable.ship);
    ...
    public Ship (Context context, float initialX, float initialY, float screenWidth, float screenHeigth){
    ...
    public void setSpriteship(Bitmap spriteship) {
        this.spriteship = spriteship;
    }
