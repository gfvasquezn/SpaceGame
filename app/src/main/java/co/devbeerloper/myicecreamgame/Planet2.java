...
public class Planet2 {
    ...
    public static final int SPRITE_SIZE_WIDTH =40;
    public static final int SPRITE_SIZE_HEIGTH=40;
    ...
    public Planet2(Context context, float screenWidth, float screenHeigth){


        //Getting bitmap from resource
        Bitmap originalBitmap= BitmapFactory.decodeResource(context.getResources(), R.drawable.planettwo);
